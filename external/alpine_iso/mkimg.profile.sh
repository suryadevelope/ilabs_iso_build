...
build_apkovl() {
	...
	msg "Generating defaults.apkovl.tar.gz"
...
profile_base() {
	...
	profile_abbrev="x"
	title="vmConsole"
	desc="Specialized edition of Alpine Linux."
	output_format="iso"
	image_ext="iso"

	kernel_flavors="virt"
	initfs_features="ata base cdrom squashfs ext4 scsi virtio"
	initfs_cmdline="modules=loop,squashfs,sd-mod console=tty0 console=ttyS0,115200 tsc=unstable nowatchdog maxcpus=1"
	syslinux_prompt="0"
